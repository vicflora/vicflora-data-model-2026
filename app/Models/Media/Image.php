 ...
 * Class Image
 *
 * Represents an image associated with a taxon concept or profile, which may
 * include metadata such as the creator, caption, rights holder, and license
 * information. This model is based on the 'images' database table, which
 * captures the core information about images used in the application.
 *
 * The model includes relationships to the image type (ControlledTerm), license
 * (ControlledTerm), and specimens that the image represents.
 *
 * @property int $id
 * @property string $uri
