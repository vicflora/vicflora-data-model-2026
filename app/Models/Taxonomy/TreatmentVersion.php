...
class TreatmentVersion extends Model
{
    ...
    /**
     * Get the name of the table that contains the sidecar fields for this model.
     * This is used by the HasSidecar trait to know which table to read/write the sidecar fields from/to.
     * @return string
     */
