 ...
 * Class TaxonTreeNode
 *
 * Represents a node in a taxonomic tree, which corresponds to a taxonomic concept 
 * (TaxonConcept) and its position within the tree. This model is based on the 
 * 'taxon_tree_nodes' database table, which captures the hierarchical structure of 
 * taxonomic concepts within a taxonomic tree.
 *
 * The model includes relationships to the TaxonTree to which the node belongs, the 
 * TaxonTreeDefItem that defines the rank and name of the node, and the parent node 
 * in the tree.
 * 
