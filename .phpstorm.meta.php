...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Models\Taxonomy\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'database.connections.pgsql.schemas' => 'array',
            ...
            'filesystems.links./var/www/vicflora-model/public/storage' => 'string',
...
'database.connections.pgsql.prefix','database.connections.pgsql.prefix_indexes','database.connections.pgsql.search_path','database.connections.pgsql.schemas','database.connections.pgsql.sslmode',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/vicflora-model/public/storage','logging.default',
...
'session.same_site','session.partitioned','session.serialization','magellan.schema','magellan.json_generator',
'magellan.sql_generator','magellan.string_generator','magellan.geodetic_srids','magellan.geodetic_default_srid','ide-helper.filename',
