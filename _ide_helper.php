...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \App\Models\Taxonomy\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Models\Taxonomy\User|false
         * @static
         */
         ...
         *
         * @return \App\Models\Taxonomy\User
         * @static
         */
...
namespace Clickbar\Magellan\Facades {
    ...
    class WKBParser {
        ...
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKB\WKBParser $instance */
    ...
    class WKTParser {
        ...
        public static function parse($input)
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKT\WKTParser $instance */
            return $instance->parse($input);
        }
         ...
         * @static
         */
        public static function parsePoint($argument)
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKT\WKTParser $instance */
            return $instance->parsePoint($argument);
        }

        /**
         * @static
         */
        public static function parseLineString($argument)
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKT\WKTParser $instance */
            return $instance->parseLineString($argument);
        }

        /**
         * @static
         */
        public static function parsePolygon($argument)
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKT\WKTParser $instance */
            return $instance->parsePolygon($argument);
        }

        /**
         * @static
         */
        public static function parseMultiPoint($argument)
        {
            /** @var \Clickbar\Magellan\IO\Parser\WKT\WKTParser $instance */
            return $instance->parseMultiPoint($argument);
        }
    ...
    class WKBGenerator {
         ...
         * @static
         */
        public static function generate($geometry)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generate($geometry);
        }

        /**
         * @static
         */
        public static function generatePoint($point)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generatePoint($point);
        }

        /**
         * @static
         */
        public static function generateLineString($lineString)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generateLineString($lineString);
        }

        /**
         * @static
         */
        public static function generateMultiLineString($multiLineString)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generateMultiLineString($multiLineString);
        }

        /**
         * @static
         */
        public static function generatePolygon($polygon)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generatePolygon($polygon);
        }

        /**
         * @static
         */
        public static function generateMultiPolygon($multiPolygon)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generateMultiPolygon($multiPolygon);
        }

        /**
         * @static
         */
        public static function generateMultiPoint($multiPoint)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generateMultiPoint($multiPoint);
        }

        /**
         * @static
         */
        public static function generateGeometryCollection($geometryCollection)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->generateGeometryCollection($geometryCollection);
        }

        /**
         * @static
         */
        public static function toPostgisGeometrySql($geometry, $schema)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->toPostgisGeometrySql($geometry, $schema);
        }

        /**
         * @static
         */
        public static function toPostgisGeographySql($geometry, $schema)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKB\WKBGenerator $instance */
            return $instance->toPostgisGeographySql($geometry, $schema);
        }
    ...
    class WKTGenerator {
        ...
        public static function generate($geometry)
        {
            /** @var \Clickbar\Magellan\IO\Generator\WKT\WKTGenerator $instance */
            return $instance->generate($geometry);
        }
    ...
    class GeojsonParser {
        ...
        public static function parse($input)
        {
            /** @var \Clickbar\Magellan\IO\Parser\Geojson\GeojsonParser $instance */
            return $instance->parse($input);
        }
         ...
         * @static
         */
        public static function parseMultiLineString($coordinates)
        {
            /** @var \Clickbar\Magellan\IO\Parser\Geojson\GeojsonParser $instance */
            return $instance->parseMultiLineString($coordinates);
        }

        /**
         * @static
         */
        public static function parsePolygon($coordinates)
        {
            /** @var \Clickbar\Magellan\IO\Parser\Geojson\GeojsonParser $instance */
            return $instance->parsePolygon($coordinates);
        }

        /**
         * @static
         */
        public static function parseMultiPoint($coordinates)
        {
            /** @var \Clickbar\Magellan\IO\Parser\Geojson\GeojsonParser $instance */
            return $instance->parseMultiPoint($coordinates);
        }

        /**
         * @static
         */
        public static function parseMultiPolygon($coordinates)
        {
            /** @var \Clickbar\Magellan\IO\Parser\Geojson\GeojsonParser $instance */
            return $instance->parseMultiPolygon($coordinates);
        }
    ...
    class GeojsonGenerator {
        ...
        public static function generatePoint($point)
        {
            /** @var \Clickbar\Magellan\IO\Generator\Geojson\GeojsonGenerator $instance */
            return $instance->generatePoint($point);
        }
        ...
        public static function generate($geometry)
        {
            //Method inherited from \Clickbar\Magellan\IO\Generator\BaseGenerator 
            /** @var \Clickbar\Magellan\IO\Generator\Geojson\GeojsonGenerator $instance */
            return $instance->generate($geometry);
        }
...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
        ...
        /**
         * @see \App\Providers\AuditFieldsServiceProvider::boot()
         * @static
         */
...
namespace  {
    ...
    class WKBParser extends \Clickbar\Magellan\Facades\WKBParser {}
    class WKTParser extends \Clickbar\Magellan\Facades\WKTParser {}
    class WKBGenerator extends \Clickbar\Magellan\Facades\WKBGenerator {}
    class WKTGenerator extends \Clickbar\Magellan\Facades\WKTGenerator {}
    class GeojsonParser extends \Clickbar\Magellan\Facades\GeojsonParser {}
    class GeojsonGenerator extends \Clickbar\Magellan\Facades\GeojsonGenerator {}
}
